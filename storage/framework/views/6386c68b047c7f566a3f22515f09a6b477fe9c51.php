    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            ...
            if($hasPermission == 1): ?>
                ...
                <?php endif ?>
                  <?php $hasPermission = App\Models\Role::hasPermission(['admin.newexpirymateriyal*'])  ? 1 : 0;
            if($hasPermission == 1): ?>
                    <li class="sidebar-menu-item <?php echo e(menuActive('admin.newexpirymateriyal.*')); ?>">
                        <a href="<?php echo e(route('admin.newexp.index')); ?>" class="nav-link ">
                            <i class="menu-icon la la-warehouse"></i>
                            <span class="menu-title"><?php echo app('translator')->get('New Expiry Materiyal'); ?></span>
                        </a>
                    </li>
                <?php endif ?>
            ...
            if($hasPermission == 1): ?>
                ...
                <?php $hasPermission = App\Models\Role::hasPermission(['admin.barcode*'])  ? 1 : 0;
            if($hasPermission == 1): ?>
                    <li class="sidebar-menu-item sidebar-dropdown">
                        <a href="javascript:void(0)" class="<?php echo e(menuActive(['admin.barcode', 'create', 'show'], 3)); ?>">
                            <i class="menu-icon la la-shopping-bag"></i>
                            <span class="menu-title"><?php echo app('translator')->get('Barcode'); ?></span>
                        </a>
                        
                        <div class="sidebar-submenu <?php echo e(menuActive(['admin.barcode', 'create', 'show'], 2)); ?>">
                            <ul>
                                <?php $hasPermission = App\Models\Role::hasPermission('admin.barcode')  ? 1 : 0;
            if($hasPermission == 1): ?>
                                    <li class="sidebar-menu-item <?php echo e(menuActive('admin.barcode')); ?>">
                                        <a href="<?php echo e(url('all-barcode')); ?>" class="nav-link">
                                            <i class="menu-icon la la-dot-circle"></i>
                                            <span class="menu-title"><?php echo app('translator')->get('All Barcode'); ?></span>
                                        </a>
                                    </li>
                                <?php endif ?>
                                <?php $hasPermission = App\Models\Role::hasPermission('admin.barcode')  ? 1 : 0;
            if($hasPermission == 1): ?>
                                    <li class="sidebar-menu-item <?php echo e(menuActive('create')); ?>">
                                        <a href="<?php echo e(route('create')); ?>" class="nav-link">
                                            <i class="menu-icon la la-dot-circle"></i>
                                            <span class="menu-title"><?php echo app('translator')->get('Create Barcode'); ?></span>
                                        </a>
                                    </li>
                                <?php endif ?>
                                <?php $hasPermission = App\Models\Role::hasPermission('admin.barcode')  ? 1 : 0;
            if($hasPermission == 1): ?>
                                    <li class="sidebar-menu-item <?php echo e(menuActive('show')); ?>">
                                        <a href="<?php echo e(route('show')); ?>" class="nav-link">
                                            <i class="menu-icon la la-dot-circle"></i>
                                            <span class="menu-title"><?php echo app('translator')->get('Show Barcode'); ?></span>
                                        </a>
                                    </li>
                                <?php endif ?>
                            </ul>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/AGIO_VIDYAGXP_WAREHOUSE/resources/views/admin/partials/sidenav.blade.php ENDPATH**/ ?>