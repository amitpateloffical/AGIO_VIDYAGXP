    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-7 text-center">
          ...
          <a href="<?php echo e(route('admin.dashboard')); ?>" class="cmn-btn mt-4"><?php echo app('translator')->get('Go to Home'); ?></a>
          <!-- route('home') -->
        </div>
      </div>
    </div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/AGIO_VIDYAGXP_WAREHOUSE/resources/views/errors/404.blade.php ENDPATH**/ ?>